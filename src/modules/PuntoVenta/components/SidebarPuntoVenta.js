...
import { FaFacebook, FaGoogle, FaProductHunt, FaTiktok } from "react-icons/fa";
import { FaCalendarWeek, FaShop } from "react-icons/fa6";

const SidebarPuntoVenta = ({ open, setOpen }) => {
  ...
  const menuSuperAdmin = [
    {
      ...
      items: [
        {
          title: "Ventas",
          url: `/manage/${companyId}/sede/${idSede}/modules/${idModulo}/ventas`,
          icon: <FaShop />,
        },
      ],
    },
    {
      ...
      items: [
        {
          title: "Productos",
          url: `/manage/${companyId}/sede/${idSede}/modules/${idModulo}/productos`,
          icon: <FaProductHunt />,
        },
      ],
    },
...
export default SidebarPuntoVenta;
